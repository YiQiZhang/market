...
pkgdatadir = $(datadir)/market
pkgincludedir = $(includedir)/market
pkglibdir = $(libdir)/market
pkglibexecdir = $(libexecdir)/market
...
OBJEXT = o
PACKAGE = market
PACKAGE_BUGREPORT = jerry_techtree@126.com
PACKAGE_NAME = market
PACKAGE_STRING = market 0.1
PACKAGE_TARNAME = market
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
RANLIB = ranlib
